                            ...
                            @foreach ($days as $d)
                                <div class="form-group row">
                                    ...
                                    <div class="input-group date col-md-5" id="{{$d}}_start" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#{{$d}}_start" name="{{$d}}_start" maxlength="5" data-toggle="datetimepicker"/>
                                    ...
                                    <div class="input-group date col-md-5" id="{{$d}}_end" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#{{$d}}_end" name="{{$d}}_end" maxlength="5" data-toggle="datetimepicker"/>
